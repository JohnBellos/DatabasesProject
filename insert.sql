...
VALUES  ('603020091-7', 'The Picture of Dorian Gray', 'Penguin Random House', 'Meggi Dannehl', 724, 'omnis dolor repellendus', 93, 'Belarusian'),
        ('613640324-2', 'The Call of the Wild', 'Wolters Kluwer', 'Megie Dannehl', 221, 'similique sunt in culpa qui officia', 49, 'Danish'),
        ('498161114-5', 'Harry Potter and the Half-Blood Prince', 'John Wiley & Sons', 'Mgie Dannehl', 997, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 77, 'Hebrew'),
		('459321124-7', 'The War of the Worlds', 'Macmillan Publishers', 'Mggie Dannehl', 832, 'Nam libero tempore', 86, 'Kazakh'),
		('133701989-5', 'The Island of Dr. Moreau', 'Cengage Learning', 'Meggie Dannhl', 642, 'Itaque earum rerum hic tenetur a sapiente delectus', 87, 'Macedonian'),
		('956553982-3', 'The Hunger Games', 'Springer Nature', 'Meggie Dnehl', 232, 'Quis nostrud exercitation ullamco', 3, 'Swahili'),
		('577364603-X', 'The Wind in the Willows', 'Bloomsbury Publishing', 'Meggie Dnnehl', 221, 'Consectetur', 68, 'Fijian'),
		('731351495-6', 'The Hunger Games', 'Wolters Kluwer', 'Meggie Danne', 650, 'Itaque earum rerum hic tenetur a sapiente delectus', 99, 'Albanian'),
		('048822420-9', 'The Hunger Games', 'Cambridge University Press', 'Meggie Dhl', 270, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 78, 'Croatian'),
		('668059626-2', 'Mostly Harmless', 'Pearson Education', 'Mrgy Skae', 959, 'ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat', 46, 'Finnish'),
		('347186029-0', 'The Chronicles of Narnia', 'Pearson Education', 'argy Skae', 248, 'Itaque earum rerum hic tenetur a sapiente delectus', 23, 'Gagauz'),
		('592059327-X', 'The Catcher in the Rye', 'Oxford University Press', 'Mary Skae', 33, 'At vero eos et accusamus et iusto odio dignissimos ducimus', 0, 'Oriya'),
		('430332205-9', 'The Call of the Wild', 'Springer Nature', 'Magy Skae', 912, 'Ut enim ad minim veniam', 53, 'Catalan'),
		...
		('030802285-8', 'the Universe and Everything', 'Elsevier', 'odfry Castrillo', 481, 'Nam libero tempore', 93, 'Northern Sotho'),
		('597728931-6', 'Harry Potter and the Chamber of Secrets', 'Springer Nature', 'Rese Cressey', 224, 'Ut enim ad minim veniam', 95, 'Quechua'),
		('058050124-8', 'The Restaurant at the End of the Universe', 'Hachette Book Group', 'Pa Habbijam', 284, 'ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat', 84, 'Kannada'),
		('575080405-4', 'Harry Potter and the Order of Phoenix', 'Cengage Learning', 'Ernn Conws', 814, 'Nam libero tempore', 73, 'Kannada'),
		('763911195-1', 'The Adventures of Huckleberry Finn', 'Pearson Education', 'Keley Bohan', 919, 'ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat', 74, 'Croatian'),
		('178908056-8', 'Pride and Prejudice', 'SAGE Publications', 'Glynis Dannett', 929, 'omnis voluptas assumenda est', 73, 'Tamil'),
		('967706803-2', 'The Restaurant at the End of the Universe', 'HarperCollins', 'Sybile Petrazzi', 243, 'Ut labore et dolore magna aliqua', 93, 'Nepali'),
		('466840140-4', 'Through the Looking Glass', 'Elsevier', 'Valerye Pazelt', 714, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae', 10, 'Gujarati'),
		('896827318-9', 'The Picture of Dorian Gray', 'Wolters Kluwer', 'Jocelyn Gogie', 420, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 3, 'Polish'),
		('675452482-0', 'The Island of Dr. Moreau', 'Taylor & Francis', 'Trenn Halesworth', 98, 'Sunt in culpa qui officia deserunt mollit anim', 1, 'Indonesian'),
		('277889190-0', 'The Catcher in the Rye', 'Bloomsbury Publishing', 'Dll Quickenden', 971, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 83, 'Northern Sotho'),
		('737344592-6', 'The Great Gatsby', 'John Wiley & Sons', 'Ferdy Van e Castele', 609, 'At vero eos et accusamus et iusto odio dignissimos ducimus', 48, 'Tok Pisin'),
		('694331971-X', 'The Fault in Our Stars', 'Simon & Schuster', 'Deni Domelo', 496, 'ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat', 37, 'Punjabi'),
		('377222920-4', 'The Wind in the Willows', 'Springer Nature', 'Tabbie de Voils', 728, 'Consectetur', 3, 'Malagasy'),
		('585064134-3', 'The Hitchhiker''s Guide to the Galaxy', 'HarperCollins', 'Cthrine Cantu', 932, 'ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat', 44, 'Maltese'),
		('764028185-7', 'The Kite Runner', 'Cambridge University Press', 'Alyse Van', 667, 'cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus', 19, 'New Zealand'),
		('042246729-4', 'The Wonderful Wizard of Oz', 'Macmillan Publishers', 'Nap Taiour', 859, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae', 39, 'Marathi'),
		('381129789-9', 'Harry Potter and the Philosopher''s Stone', 'Elsevier', 'Muffin Hltaway', 698, 'Ut enim ad minim veniam', 86, 'Dari'),
		('988663019-1', 'The Adventures of Huckleberry Finn', 'McGraw-Hill Education', 'Myrtice silmon', 472, 'cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus', 78, 'Bislama'),
		('188690335-2', 'the Universe and Everything', 'Oxford University Press', 'Nicholas McNesh', 314, 'Lorem ipsum dolor sit amet', 11, 'Japanese'),
		('148184850-X', 'The Picture of Dorian Gray', 'Oxford University Press', 'Colman Syds', 191, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae', 41, 'Hindi'),
		('811181230-2', 'Life', 'Cengage Learning', 'Carver Suran', 569, 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur', 20, 'Croatian'),
		('970287388-6', 'The Alchemist', 'Hachette Book Group', 'Lavena Valentine', 967, 'omnis voluptas assumenda est', 93, 'Albanian'),
		('348736226-0', 'The Girl with the Dragon Tattoo', 'Bloomsbury Publishing', 'Emyl Purvey', 156, 'Ut labore et dolore magna aliqua', 95, 'Spanish'),
		('433050464-2', 'The Fault in Our Stars', 'Wolters Kluwer', 'Ramo Abriani', 964, 'Quis nostrud exercitation ullamco', 7, 'Yiddish'),
		('856989563-1', 'The Catcher in the Rye', 'Elsevier', 'Loree Akat', 264, 'Itaque earum rerum hic tenetur a sapiente delectus', 90, 'Yiddish'),
		...
		('031624416-3', 'The Picture of Dorian Gray', 'Simon & Schuster', 'Marigld Threadgold', 63, 'Quos dolores et quas molestias excepturi sint occaecati', 79, 'Azeri'),
		('436756553-X', 'The Help', 'John Wiley & Sons', 'Cele Scoines', 766, 'Nam libero tempore', 6, 'Northern Sotho'),
		('846118339-8', 'The Wind in the Willows', 'Springer Nature', 'Rchell Eagar', 330, 'adipisci velit', 66, 'Dari'),
		('257004637-X', 'The Adventures of Tom Sawyer', 'Macmillan Publishers', 'Ary Stevings', 418, 'Neque porro quisquam est', 6, 'Irish Gaelic'),
		('165976539-0', 'Harry Potter and the Goblet of Fire', 'Elsevier', 'Claborne Coldbath', 809, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet', 46, 'English'),
		('052223061-X', 'The Scarlet Letter', 'Macmillan Publishers', 'Ignazio Twiell', 961, 'Ut labore et dolore magna aliqua', 93, 'Northern Sotho'),
		('182162838-1', 'Alice''s Adventures in Wonderland', 'Pearson Education', 'Este Melin', 288, 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur', 75, 'Portuguese'),
		('854519326-2', 'The Alchemist', 'Cengage Learning', 'Merril Lys', 833, 'Et harum quidem rerum facilis est et expedita distinctio', 80, 'Zulu'),
		('528638252-5', 'Harry Potter and the Half-Blood Prince', 'Wolters Kluwer', 'Collete Ausher', 210, 'cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus', 90, 'Norwegian'),
		('973950447-7', 'To Kill a Mockingbird', 'John Wiley & Sons', 'Aeriela Macknes', 921, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae', 60, 'Azeri'),
		('988672601-6', 'The Adventures of Huckleberry Finn', 'Springer Nature', 'Godad Humphery', 718, 'Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae', 85, 'Thai'),
...
VALUES  ('603020091-7', 'The Picture of Dorian Gray', 'Penguin Random House', 'Meggie Dannehl', 724, 'omnis dolor repellendus', 'Belarusian'),
		...
		('433050464-2', 'The Fault in Our Stars', 'Wolters Kluwer', 'Ramon Abriani', 964, 'Quis nostrud exercitation ullamco', 'Yiddish'),
		('856989563-1', 'The Catcher in the Rye', 'Elsevier', 'Loree Akast', 264, 'Itaque earum rerum hic tenetur a sapiente delectus', 'Yiddish');
>>>>>>> 4c7dcdfe9dad188b63e7918c49f57d6617490720
