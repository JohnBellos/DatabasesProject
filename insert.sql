...
VALUES ('1','Shea','Lampert','slampert0@webeden.co.uk','12','M','12'),
       ('2','Currie','Deacon','cdeacon1@woothemes.com','11','M','8'),
       ('3','Carmella','Gamell','cgamell2@vinaora.com','10','F','8'),
       ('4','Briny','Mallett','bmallett3@amazon.de','7','F','12'),
       ('5','Willi','Robardey','wrobardey4@scribd.com','11','F','8');