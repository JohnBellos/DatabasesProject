...
VALUES  ('603020091-7', 'The Picture of Dorian Gray', 'Penguin Random House', 'Meggie Dannehl', 724, 'omnis dolor repellendus', 93, 'Belarusian'),
        ('613640324-2', 'The Call of the Wild', 'Wolters Kluwer', 'Meggie Dannehl', 221, 'similique sunt in culpa qui officia', 49, 'Danish'),
        ('498161114-5', 'Harry Potter and the Half-Blood Prince', 'John Wiley & Sons', 'Meggie Dannehl', 997, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 77, 'Hebrew'),
		('459321124-7', 'The War of the Worlds', 'Macmillan Publishers', 'Meggie Dannehl', 832, 'Nam libero tempore', 86, 'Kazakh'),
		('133701989-5', 'The Island of Dr. Moreau', 'Cengage Learning', 'Meggie Dannehl', 642, 'Itaque earum rerum hic tenetur a sapiente delectus', 87, 'Macedonian'),
		('956553982-3', 'The Hunger Games', 'Springer Nature', 'Meggie Dannehl', 232, 'Quis nostrud exercitation ullamco', 3, 'Swahili'),
		('577364603-X', 'The Wind in the Willows', 'Bloomsbury Publishing', 'Meggie Dannehl', 221, 'Consectetur', 68, 'Fijian'),
		('731351495-6', 'The Hunger Games', 'Wolters Kluwer', 'Meggie Dannehl', 650, 'Itaque earum rerum hic tenetur a sapiente delectus', 99, 'Albanian'),
		('048822420-9', 'The Hunger Games', 'Cambridge University Press', 'Meggie Dannehl', 270, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident', 78, 'Croatian'),
		...
		('347186029-0', 'The Chronicles of Narnia', 'Pearson Education', 'Margy Skae', 248, 'Itaque earum rerum hic tenetur a sapiente delectus', 23, 'Gagauz'),
		('592059327-X', 'The Catcher in the Rye', 'Oxford University Press', 'Margy Skae', 33, 'At vero eos et accusamus et iusto odio dignissimos ducimus', 0, 'Oriya'),
		('430332205-9', 'The Call of the Wild', 'Springer Nature', 'Margy Skae', 912, 'Ut enim ad minim veniam', 53, 'Catalan'),
